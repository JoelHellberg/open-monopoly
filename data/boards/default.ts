...
export const allownableBoard: Tile[] = [
  { id: 1, name: "Go", type: "event", subtype: "go" },
  ...
  { id: 10, name: "Connecticut Avenue", type: "ownable", subtype: "property", color: "light-blue",
    price: 120, houseCost: 50, rent: [7, 35, 105, 210, 380, 570], },

  { id: 11, name: "Jail / Just Visiting", type: "event", subtype: "jail" },

  { id: 12, name: "St Charles Place", type: "ownable", subtype: "property", color: "pink",
    price: 140, houseCost: 100, rent: [10, 50, 150, 300, 540, 810], },

  { id: 13, name: "States Avenue", type: "ownable", subtype: "property", color: "pink",
    price: 140, houseCost: 100, rent: [10, 50, 150, 300, 540, 810], },

  { id: 14, name: "Pennsylvania Railroad", type: "ownable", subtype: "transportation",
    price: 200, rent: [20, 40, 80, 160, 320, 640, 1280, 2560], },
  ...
  { id: 20, name: "New York Avenue", type: "ownable", subtype: "property", color: "orange",
    price: 200, houseCost: 100, rent: [13, 65, 195, 390, 700, 1050], },

  { id: 21, name: "Free Parking", type: "event", subtype: "parking" },

  { id: 22, name: "Kentucky Avenue", type: "ownable", subtype: "property", color: "red",
    price: 220, houseCost: 150, rent: [17, 85, 255, 510, 920, 1380], },

  { id: 23, name: "Indiana Avenue", type: "ownable", subtype: "property", color: "red",
    price: 220, houseCost: 150, rent: [17, 85, 255, 510, 920, 1380], },

  { id: 24, name: "B & O Railroad", type: "ownable", subtype: "transportation",
    price: 200, rent: [20, 40, 80, 160, 320, 640, 1280, 2560], },

  { id: 25, name: "Illinois Avenue", type: "ownable", subtype: "property", color: "red",
    price: 240, houseCost: 150, rent: [18, 90, 270, 540, 970, 1460], },

  { id: 26, name: "Water Works", type: "ownable", subtype: "company",
    price: 150, multiplier: [8, 16, 32, 64], },
  ...
  { id: 30, name: "Marvin Gardens", type: "ownable", subtype: "property", color: "yellow",
    price: 280, houseCost: 150, rent: [20, 100, 300, 600, 1080, 1620], },

  { id: 31, name: "Go To Jail", type: "event", subtype: "toJail" },

  { id: 32, name: "Pacific Avenue", type: "ownable", subtype: "property", color: "green",
    price: 300, houseCost: 200, rent: [25, 125, 375, 750, 1350, 2025], },

  { id: 33, name: "North Carolina Avenue", type: "ownable", subtype: "property", color: "green",
    price: 300, houseCost: 200, rent: [25, 125, 375, 750, 1350, 2025], },

  { id: 34, name: "Short Line", type: "ownable", subtype: "transportation",
    price: 200, rent: [20, 40, 80, 160, 320, 640, 1280, 2560], },
  ...
  { id: 40, name: "Boardwalk", type: "ownable", subtype: "property", color: "dark-blue",
    price: 400, houseCost: 200, rent: [28, 140, 420, 840, 1510, 2270], },
];
