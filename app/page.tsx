    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        <div className="flex flex-col gap-4 w-full">
          ...
          <button
            className="outline p-2 rounded-2xl hover:bg-gray-100 cursor-pointer w-full text-left"
            onClick={() => hostGame(defaultBoard, selectedColor)}
          >
            Host game
          </button>
          ...
          <div className="flex flex-col gap-2 p-4 border rounded-xl">
            ...
            <button
              ...
              onClick={() => joinGame(sessionId, selectedColor)}
